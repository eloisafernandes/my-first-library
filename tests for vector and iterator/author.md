...
- Nome: *Eloisa Medeiros Fernandes*
- Email: *fmasiole@gmail.com*
- Turma: *T01*
...
- [x] `insert()` \times 6, but i implemented only 4 them  (18 credits)
- [x] `reserve()` (3 credits)
- [x] `shrink_to_fit()` (3 credits)
- [x] `assign()` \times 3 (9 credits)
- [x] `erase()` \times 4, but i implemented only 2 them (12 credits)
